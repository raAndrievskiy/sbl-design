...
export const Portfolio: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (event: any) => {
      ...
      const mouseMoved = () => {
        if (mouse.moved) {
          parallaxIt('.portfolioImage1', -50)
          parallaxIt('.portfolioImage2', -20)
          parallaxIt('.portfolioImage3', 30)
          parallaxIt('.portfolioImage4', 10)
          parallaxIt('.portfolioImage5', 10)
          parallaxIt('.portfolioImage6', 10)
          parallaxIt('.portfolioImage7', 10)
        }
        mouse.moved = false
      }
      ...
      <div className={styles.portfolioImages} ref={portfolioImagesRef}>
        ...
        {portfolioImagesData.map(images => (
          <img
            ...
            className={`${['portfolioImage' + images.id]} test`}
            src={images.src}
            alt=""
            key={images.id}
          />
