  ...
  return (
    <div className={`${styles.portfolio} portfolio`}>
      ...
      <span className={styles.portfolioDescription}>
        ...
        административные и производственные здания, жилые комплексы и больницы,
        торговые центры и аэропорты, в зависимости от типа и назначения здания
        подбираем наиболее эффективное индивидуальное решение.
      </span>
