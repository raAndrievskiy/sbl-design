      ...
      <Container>
        <div className={styles.about}>
          ...
          <span className={`subtitle color-white ${styles.aboutSubtitle}`}>
            Мы учитываем технические условия <br /> и находим оптимальные
            решения для проектов строительства шахт <br />и монтажа лифтового
            оборудования. Благодаря нашему опыту и базам решений, мы успешно
            справляемся с любыми сложностями. Используем CRM 1C Bitrix24© для
            удобного ведения проектов, обмена информацией и контроля процессов.
          </span>
          <>
            <LineWhite />
